    ...
    return (
        <div className="container">
            ...
            <ul className="list-group mb-3">
                ...
                <div className="h6 col-md-3 mr-auto">Product Image</div>
                <div className="h6 col-md-3 mr-auto">Product Title</div>
                <div className="h6 col-md-2 mr-auto">Price</div>
                <div className="h6 col-md-2 mr-auto">Quantity</div>
                    <div className="h6 col-md-2 mr-auto">Total Price</div>
                </li>
            {props.location.state.cart.length>1 ? props.location.state.cart.map((cartItem, idx) => (
                ...
                <li className="list-group-item d-flex justify-content-between lh-condensed">
                <div className="h6 col-md-2 mr-auto">Total Amount</div>
            ...
            <button className="btn btn-info btn-block" onClick={handleProceedToCheckout}>Proceed to Checkout</button>
            <br />
            {proceedCheckout && 
            <>
            <Formik
                ...
                >
                    <Form>
                        ...
                        <div className="clearfix">
                            <button className="btn btn-info float-left" type="submit">Place Order</button>
